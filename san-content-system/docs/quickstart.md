# san-content-system Quickstart

## 定位

`san-content-system` 是 `san-skills` 里的进阶内容工程模块。
...
```bash
npx -y skills add sansan19900801/san-content-system -g --all
```

单独安装本模块：

```bash
npx -y skills add sansan19900801/san-content-system --skill san-content-system
```

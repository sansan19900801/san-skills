...
# san-content-risk-check：内容发布风险检查
...
|---|---|
| 整体检查流程 | [审核流程](#审核流程) |
| 违法/诈骗/色情/暴力等硬红线 | [内容安全与公共风险](#内容安全与公共风险) |
| 翻墙/海外账号/ChatGPT | [网络访问与海外账号](#网络访问与海外账号) |
| 算命/塔罗/风水 | [玄学占卜与封建迷信](#玄学占卜与封建迷信) |
| 性暗示/缩写/emoji | [轻度性暗示缩写和变体辱骂](#轻度性暗示缩写和变体辱骂) |
| 金融/医疗/教育推广 | [受限推广与全局高风险主题](#受限推广与全局高风险主题) |
| 广告/招聘/接单 | [商业广告招聘和接单](#商业广告招聘和接单) |
| 微信/手机号/外链/二维码 | [外链联系方式和导流](#外链联系方式和导流) |
| 绝对化用语/虚假宣传 | [宣传价格和证明](#宣传价格和证明) |
| 功效/治愈/减肥/医美 | [医疗健康美容和食品](#医疗健康美容和食品) |
| 图片/视频/隐私/AI换脸 | [图片视频声音和账号资料](#图片视频声音和账号资料) |
| 品牌合作/测评/佣金 | [商业合作测评和协同营销](#商业合作测评和协同营销) |
| 视频免责声明小字 | [视频三行贴片](#视频三行贴片) |
| 输出格式长什么样 | [默认输出](#默认输出) |
...
以下示例展示对一篇小红书接单笔记的完整检查：

> **原文**：做PPT接单啦！价格美丽，一单50-200，需要的加微信zhangsan123，包修改到满意为止，全网最低价，不信看我主页作品。

```markdown
## 先说结论
**平台机器审核**：存在明显触发点——完整微信号+价格+行动邀请构成广告结构
**内容本身**：存在违规导流风险，小红书不允许正文直接放站外联系方式

## 建议优先处理

### 1．「加微信zhangsan123」
- **具体问题**：正文直接放站外联系方式，小红书机器会识别导流，可能导致笔记限流或下架
- **怎么处理**：删掉微信号。如果确实要接单，使用小红书官方的"店铺"或"薯店"功能，或引导用户通过站内私信联系

### 2．「全网最低价」
- **具体问题**：绝对化价格承诺，属于无法证明的宣传用语
- **怎么处理**：改成具体价格区间即可，如"一单50-200元"，删掉"全网最低价"

## 可能触发机器审核

### 1．「加微信zhangsan123」
- **机器可能怎样识别**：微信号是明确的联系方式信号，配合"价格"和"需要的"构成完整广告结构
- **是否可能误伤**：不是误伤，确实是导流
- **怎么处理**：删除，改用官方入口

## 发布前确认
- 你是否有小红书店铺或薯店资质？如果有，可以直接挂商品链接，不需要导流到微信
```
...
| 场景 | 用哪个 Skill |
|------|-------------|
| 内容整体行不行、五维诊断 | `san-content` |
| 小红书标题有没有问题 | `san-xhs-title` |
| 开头留不住人 | `san-hook` |
| 段落衔接、口播流畅度 | `san-script-flow` |
| 文字像 AI 写的 | `san-ai-check` |
| 内容没共鸣 | `san-resonate` |
| 内容为什么能火、传播机制 | `san-spread` |
| 发布前合规排雷 | `san-content-risk-check`（本 skill） |

`san-content` 做整体诊断时如果发现合规风险，会引用本 skill 做专项检查。本 skill 只负责风险定位和最小修改动作，不重写全文。
...
![付费答疑群二维码](https://raw.githubusercontent.com/sansan19900801/sansan-content-risk-check/main/assets/support-qr.jpg)
